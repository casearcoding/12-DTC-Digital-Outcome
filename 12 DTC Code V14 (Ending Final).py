...
**                                                                                                                                                **""")
    ...
    if next == "Y":
        chance = random.randint(Zero, One)
        if chance == One:
            user_damage = user_damage*Two
            print("""**                                                                                                                                                **
...
# Attack Menu
while user_health > Zero and computer_health > Zero:
    chosen_CA = Computer_Attacks[random.randint(Zero, Four)]
    print("""                                                                                                                                                
...
**                                                                                                                                                **""".format(user_health, computer_health))
    if user_health > Zero and computer_health > Zero:
...
*                                                              WWWWWWWWW   WWWWWWWWW            IIIIIIIII         NNN         NNN           *      *
...
*                          *                                                                                                                     * *
 *     *                                                                                                           *                         *    *
*    *                                          LLL                        OOO                 SSSSSSSS         EEEEEEEEEEEEEEE                    *
 *                  *              *            LLL                     OOOOOOOOO           SSSSSSSSSSSSSS      EEEEEEEEEEEE                      * *
* *   *                    *                    LLL                   OOO       OOO        SSS                  EEE                           *    *
 *     *               *        *               LLL                  OOO         OOO       SSS                  EEE                                 *
*   *                     * *                   LLL                  OOO         OOO       SSS                  EEE                         *   *  *
 *            *      *   * * *   *       *      LLL                  OOO         OOO       SSS                  EEE                                 *
*  *    *                 * *                   LLL                  OOO         OOO        SSSSSSSSS           EEEEEEEEE                    *     *
 *                     *        *               LLL                  OOO         OOO         SSSSSSSSSS         EEEEEEEEE                     *     *
*     *                    *                    LLL                  OOO         OOO                  SSS       EEE                           * *  *
 *  *               *             *             LLL                  OOO         OOO                   SSS      EEE                                 *
*  *    *                                       LLL                  OOO         OOO                   SSS      EEE                         *   *  *
 *   *                                          LLL                   OOO       OOO                    SSS      EEE                             *   *
*                          *                    LLLLLLLLLLLLLL          OOOOOOOOO          SSSSSSSSSSSSSS       EEEEEEEEEEEE                *      *
 *  *   *                                       LLLLLLLLLLLLLLL            OOO                SSSSSSSS          EEEEEEEEEEEEEEE                   * *
*                                                                                                                                             *    *
 *     *       *     *         *       *     *         *   *      *       *    *          *            *   *         *         *          *         *
*   *        *           *      *    *           *           *           *  *        *           *           *           *   *       *        *    *
 *    *   *        *          *        *   *          *            *          *            *          *            *     *       *         *      *""")
