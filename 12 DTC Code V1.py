...
# Menu
print("""   Welcome to this epic battle against the deadly dental monster!
...
Each round, you will have to defeat a new attack, in which both you and the dental monster can score up to three points against each other. You have fifteen layers of enamel to protect you, don’t lose them all…
