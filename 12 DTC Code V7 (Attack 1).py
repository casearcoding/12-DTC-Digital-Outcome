...
def damage_point_chance(user_damage):
    print("""**                                                                                                                                                **
**    A new, untested dental product has come out. If it works, you can double your damage points! But if it doesn't, you lose all your points!   **
**                                   Do you want to try it? Type 'Y' to take a chance, or any other key to quit                                   **
**                                                                                                                                                **""")
...
**                                                                     00000                                                                      **
**                                                                                                                                                **
**                                                      poinst against the Dental Monster!                                                        **                                                                                                                                               **
**                                                                                                                                                **
**                                                                                                                                                **
**                                                                                                                                                **
**                                                                                                                                                **
