...
**                                                                                                                                                **
**                                                                                                                                                **
**      WWW                     WWW      IIIIIIIIIIIIIII            NNN                  NNN            EEEEEEEEEEEEEEE      RRRRRRRRRRRR         **
**      WWW                     WWW         IIIIIIIII            NNNNNNNNN            NNNNNNNNN         EEEEEEEEEEEEEE       RRR        RRR       **
**      WWW                     WWW            III             NNN       NNN        NNN       NNN       EEE                  RRR         RRR      **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR         RRR      **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR         RRR      **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR        RRR       **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEEEEEEEEEEE         RRR      RRR         **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEEEEEEEEEEE         RRRRRRRRRR           **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR      RRR         **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR        RRR       **
**      WWW         WWW         WWW            III            NNN         NNN      NNN         NNN      EEE                  RRR         RRR      **
**       WWW       WWWWW       WWW             III            NNN         NNN      NNN         NNN      EEE                  RRR         RRR      **
**         WWWWWWWWW   WWWWWWWWW            IIIIIIIII         NNN         NNN      NNN         NNN      EEEEEEEEEEEEEE       RRR         RRR      **
**            WWW         WWW            IIIIIIIIIIIIIII      NNN         NNN      NNN         NNN      EEEEEEEEEEEEEEE      RRR         RRR      **
**                                                                                                                                                **
**                                                                                                                                                **
**                                                                                                                                                **
**                                                                                                                                                **
